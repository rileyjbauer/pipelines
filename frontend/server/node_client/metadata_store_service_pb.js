...
goog.object.extend(proto, metadata_store_pb);
...
proto.ml_metadata.ArtifactAndType.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifact: (f = msg.getArtifact()) && metadata_store_pb.Artifact.toObject(includeInstance, f),
    type: (f = msg.getType()) && metadata_store_pb.ArtifactType.toObject(includeInstance, f)
  };
...
proto.ml_metadata.ArtifactAndType.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.Artifact;
      reader.readMessage(value,metadata_store_pb.Artifact.deserializeBinaryFromReader);
      msg.setArtifact(value);
      break;
    case 2:
      var value = new metadata_store_pb.ArtifactType;
      reader.readMessage(value,metadata_store_pb.ArtifactType.deserializeBinaryFromReader);
      msg.setType(value);
      break;
    default:
      reader.skipField();
...
proto.ml_metadata.ArtifactAndType.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      metadata_store_pb.Artifact.serializeBinaryToWriter
    );
  }
  f = message.getType();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      metadata_store_pb.ArtifactType.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.ArtifactAndType.prototype.getArtifact = function() {
  return /** @type{?proto.ml_metadata.Artifact} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.Artifact, 1));
};
...
proto.ml_metadata.ArtifactAndType.prototype.getType = function() {
  return /** @type{?proto.ml_metadata.ArtifactType} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.ArtifactType, 2));
};
  ...
  while (reader.nextField()) {
    ...
    case 1:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.ml_metadata.ArtifactStruct.deserializeBinaryFromReader, "");
         });
      break;
    default:
      reader.skipField();
...
proto.ml_metadata.ArtifactStruct.prototype.setArtifact = function(value) {
  jspb.Message.setOneofWrapperField(this, 1, proto.ml_metadata.ArtifactStruct.oneofGroups_[0], value);
};
...
proto.ml_metadata.ArtifactStruct.prototype.setMap = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.ml_metadata.ArtifactStruct.oneofGroups_[0], value);
};
...
proto.ml_metadata.ArtifactStruct.prototype.setList = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.ml_metadata.ArtifactStruct.oneofGroups_[0], value);
};
...
proto.ml_metadata.PutArtifactsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.Artifact.toObject, includeInstance)
  };
...
proto.ml_metadata.PutArtifactsRequest.prototype.getArtifactsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Artifact>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Artifact, 1));
};
...
proto.ml_metadata.PutArtifactsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifactIdsList: jspb.Message.getRepeatedField(msg, 1)
  };
...
proto.ml_metadata.PutArtifactTypeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifactType: (f = msg.getArtifactType()) && metadata_store_pb.ArtifactType.toObject(includeInstance, f),
    canAddFields: jspb.Message.getField(msg, 2),
    canDeleteFields: jspb.Message.getField(msg, 3),
    allFieldsMatch: jspb.Message.getField(msg, 4)
  };
...
proto.ml_metadata.PutArtifactTypeRequest.prototype.getArtifactType = function() {
  return /** @type{?proto.ml_metadata.ArtifactType} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.ArtifactType, 1));
};
...
proto.ml_metadata.PutArtifactTypeRequest.prototype.clearArtifactType = function() {
  this.setArtifactType(undefined);
};
...
proto.ml_metadata.PutArtifactTypeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    typeId: jspb.Message.getField(msg, 1)
  };
...
proto.ml_metadata.PutExecutionsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.Execution.toObject, includeInstance)
  };
...
proto.ml_metadata.PutExecutionsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.Execution;
      reader.readMessage(value,metadata_store_pb.Execution.deserializeBinaryFromReader);
...
proto.ml_metadata.PutExecutionsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      metadata_store_pb.Execution.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.PutExecutionsRequest.prototype.getExecutionsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Execution>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Execution, 1));
};
...
proto.ml_metadata.PutExecutionsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    executionIdsList: jspb.Message.getRepeatedField(msg, 1)
  };
...
proto.ml_metadata.PutExecutionTypeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    executionType: (f = msg.getExecutionType()) && metadata_store_pb.ExecutionType.toObject(includeInstance, f),
    canAddFields: jspb.Message.getField(msg, 2),
    canDeleteFields: jspb.Message.getField(msg, 3),
    allFieldsMatch: jspb.Message.getField(msg, 4)
  };
...
proto.ml_metadata.PutExecutionTypeRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.ExecutionType;
      reader.readMessage(value,metadata_store_pb.ExecutionType.deserializeBinaryFromReader);
...
proto.ml_metadata.PutExecutionTypeRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      metadata_store_pb.ExecutionType.serializeBinaryToWriter
    );
  }
  f = /** @type {boolean} */ (jspb.Message.getField(message, 2));
  if (f != null) {
...
proto.ml_metadata.PutExecutionTypeRequest.prototype.getExecutionType = function() {
  return /** @type{?proto.ml_metadata.ExecutionType} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.ExecutionType, 1));
};
...
proto.ml_metadata.PutExecutionTypeRequest.prototype.clearExecutionType = function() {
  this.setExecutionType(undefined);
};
...
proto.ml_metadata.PutEventsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.Event.toObject, includeInstance)
  };
...
proto.ml_metadata.PutEventsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.Event;
      reader.readMessage(value,metadata_store_pb.Event.deserializeBinaryFromReader);
      msg.addEvents(value);
      break;
    default:
      reader.skipField();
...
proto.ml_metadata.PutEventsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      metadata_store_pb.Event.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.PutEventsRequest.prototype.getEventsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Event>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Event, 1));
};
 ...
 * @const
 */
proto.ml_metadata.PutExecutionRequest.repeatedFields_ = [2];
...
proto.ml_metadata.PutExecutionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    execution: (f = msg.getExecution()) && metadata_store_pb.Execution.toObject(includeInstance, f),
...
proto.ml_metadata.PutExecutionRequest.ArtifactAndEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifact: (f = msg.getArtifact()) && metadata_store_pb.Artifact.toObject(includeInstance, f),
    event: (f = msg.getEvent()) && metadata_store_pb.Event.toObject(includeInstance, f)
  };
...
proto.ml_metadata.PutExecutionRequest.ArtifactAndEvent.prototype.getEvent = function() {
  return /** @type{?proto.ml_metadata.Event} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.Event, 2));
};
...
proto.ml_metadata.PutExecutionRequest.prototype.getExecution = function() {
  return /** @type{?proto.ml_metadata.Execution} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.Execution, 1));
};
...
proto.ml_metadata.PutExecutionRequest.prototype.clearArtifactEventPairsList = function() {
  this.setArtifactEventPairsList([]);
};
 ...
 * @const
 */
proto.ml_metadata.PutExecutionResponse.repeatedFields_ = [2];
...
proto.ml_metadata.PutExecutionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    artifactIdsList: jspb.Message.getRepeatedField(msg, 2)
  };
 ...
 * @const
 */
proto.ml_metadata.PutTypesRequest.repeatedFields_ = [1,2];
...
proto.ml_metadata.PutTypesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.ArtifactType.toObject, includeInstance),
    executionTypesList: jspb.Message.toObjectList(msg.getExecutionTypesList(),
    metadata_store_pb.ExecutionType.toObject, includeInstance)
  };
...
proto.ml_metadata.PutTypesRequest.prototype.getArtifactTypesList = function() {
  return /** @type{!Array<!proto.ml_metadata.ArtifactType>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.ArtifactType, 1));
};
...
proto.ml_metadata.PutTypesRequest.prototype.getExecutionTypesList = function() {
  return /** @type{!Array<!proto.ml_metadata.ExecutionType>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.ExecutionType, 2));
};
 ...
 * @const
 */
proto.ml_metadata.PutTypesResponse.repeatedFields_ = [1,2];
...
proto.ml_metadata.PutTypesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    artifactTypeIdsList: jspb.Message.getRepeatedField(msg, 1),
    executionTypeIdsList: jspb.Message.getRepeatedField(msg, 2)
  };
...
proto.ml_metadata.PutContextTypeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    contextType: (f = msg.getContextType()) && metadata_store_pb.ContextType.toObject(includeInstance, f),
    canAddFields: jspb.Message.getField(msg, 2),
    canDeleteFields: jspb.Message.getField(msg, 3),
    allFieldsMatch: jspb.Message.getField(msg, 4)
  };
...
proto.ml_metadata.PutContextTypeRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.ContextType;
      reader.readMessage(value,metadata_store_pb.ContextType.deserializeBinaryFromReader);
...
proto.ml_metadata.PutContextTypeRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      metadata_store_pb.ContextType.serializeBinaryToWriter
    );
  }
  f = /** @type {boolean} */ (jspb.Message.getField(message, 2));
  if (f != null) {
...
proto.ml_metadata.PutContextTypeRequest.prototype.getContextType = function() {
  return /** @type{?proto.ml_metadata.ContextType} */ (
    jspb.Message.getWrapperField(this, metadata_store_pb.ContextType, 1));
};
...
proto.ml_metadata.PutContextsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.Context.toObject, includeInstance)
  };
...
proto.ml_metadata.PutContextsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.Context;
      reader.readMessage(value,metadata_store_pb.Context.deserializeBinaryFromReader);
...
proto.ml_metadata.PutContextsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      metadata_store_pb.Context.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.PutContextsRequest.prototype.getContextsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Context>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Context, 1));
};
...
proto.ml_metadata.PutContextsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    contextIdsList: jspb.Message.getRepeatedField(msg, 1)
  };
...
proto.ml_metadata.PutAttributionsAndAssociationsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.Attribution.toObject, includeInstance),
    associationsList: jspb.Message.toObjectList(msg.getAssociationsList(),
    metadata_store_pb.Association.toObject, includeInstance)
  };
...
proto.ml_metadata.PutAttributionsAndAssociationsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.Attribution;
      reader.readMessage(value,metadata_store_pb.Attribution.deserializeBinaryFromReader);
      msg.addAttributions(value);
      break;
    case 2:
      var value = new metadata_store_pb.Association;
      reader.readMessage(value,metadata_store_pb.Association.deserializeBinaryFromReader);
...
proto.ml_metadata.PutAttributionsAndAssociationsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      metadata_store_pb.Attribution.serializeBinaryToWriter
    );
  }
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      metadata_store_pb.Association.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.PutAttributionsAndAssociationsRequest.prototype.getAttributionsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Attribution>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Attribution, 1));
};
...
proto.ml_metadata.PutAttributionsAndAssociationsRequest.prototype.getAssociationsList = function() {
  return /** @type{!Array<!proto.ml_metadata.Association>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.Association, 2));
};
...
proto.ml_metadata.PutParentContextsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.ParentContext.toObject, includeInstance)
  };
...
proto.ml_metadata.PutParentContextsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new metadata_store_pb.ParentContext;
      reader.readMessage(value,metadata_store_pb.ParentContext.deserializeBinaryFromReader);
...
proto.ml_metadata.PutParentContextsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      metadata_store_pb.ParentContext.serializeBinaryToWriter
    );
  }
};
...
proto.ml_metadata.PutParentContextsRequest.prototype.getParentContextsList = function() {
  return /** @type{!Array<!proto.ml_metadata.ParentContext>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.ParentContext, 1));
};
...
proto.ml_metadata.GetArtifactsByTypeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    typeName: jspb.Message.getField(msg, 1)
  };
...
proto.ml_metadata.GetArtifactsByURIRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    uri: jspb.Message.getField(msg, 1)
  };
 ...
 * @return {string}
 */
proto.ml_metadata.GetArtifactsByURIRequest.prototype.getUri = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.ml_metadata.GetArtifactsByURIRequest.prototype.setUri = function(value) {
  jspb.Message.setField(this, 1, value);
};


proto.ml_metadata.GetArtifactsByURIRequest.prototype.clearUri = function() {
  jspb.Message.setField(this, 1, undefined);
};
 ...
 * @return {boolean}
 */
proto.ml_metadata.GetArtifactsByURIRequest.prototype.hasUri = function() {
  return jspb.Message.getField(this, 1) != null;
};
...
proto.ml_metadata.GetExecutionTypesResponse.prototype.getExecutionTypesList = function() {
  return /** @type{!Array<!proto.ml_metadata.ExecutionType>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.ExecutionType, 1));
};
...
proto.ml_metadata.GetArtifactTypesByIDRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    typeIdsList: jspb.Message.getRepeatedField(msg, 1)
  };
...
proto.ml_metadata.GetContextTypesByIDResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    metadata_store_pb.ContextType.toObject, includeInstance)
  };
...
proto.ml_metadata.GetContextTypesByIDResponse.prototype.getContextTypesList = function() {
  return /** @type{!Array<!proto.ml_metadata.ContextType>} */ (
    jspb.Message.getRepeatedWrapperField(this, metadata_store_pb.ContextType, 1));
};
...
proto.ml_metadata.GetParentContextsByContextRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    contextId: jspb.Message.getField(msg, 1)
  };
